...
#include <md25_msgs/StampedEuler.h>

// The pointer to euler message publisher
ros::Publisher * eulerMessagePublisherPtr;

void toEuler(const geometry_msgs::Quaternion & quaternion, md25_msgs::Euler * euler) {
...
void odomCallback(const nav_msgs::Odometry::ConstPtr & odomMessage) {
    ...
    // Convert to euler
    md25_msgs::StampedEuler stampedEuler;
...
int main(int argc, char** argv) {
    ...
    // Create publisher
    ros::Publisher eulerMessagePublisher = nodeHandle.advertise<md25_msgs::StampedEuler>("euler", 20);
